...
const THEMES = {
  dark: {
    id: 'dark', name: 'Dark Nebula', icon: '🌙',
    bg: '#09090f', chatBg: '#09090f',
    bgGrad: 'linear-gradient(160deg, #09090f 0%, #0d0d21 100%)',
    card: 'rgba(255,255,255,0.04)', cardBorder: 'rgba(255,255,255,0.08)',
    header: 'rgba(9,9,15,0.85)', footer: 'rgba(9,9,15,0.9)',
    text: '#f1f0ff', textMuted: 'rgba(255,255,255,0.42)',
    accent: '#8b5cf6', accentLight: '#a78bfa',
    accentGrad: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)',
    bubbleMe: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)',
    bubbleMeText: '#ffffff',
    bubbleThem: 'rgba(255,255,255,0.06)', bubbleThemBorder: 'rgba(255,255,255,0.1)',
    bubbleThemText: '#f1f0ff',
    inputBg: 'rgba(255,255,255,0.05)', inputBorder: 'rgba(255,255,255,0.1)',
    inputText: '#f1f0ff', placeholder: 'rgba(255,255,255,0.3)',
    iconMuted: 'rgba(255,255,255,0.4)',
    glass: 'rgba(255,255,255,0.05)', glassBorder: 'rgba(255,255,255,0.08)',
    divider: 'rgba(255,255,255,0.07)',
    glow: 'rgba(139,92,246,0.35)', dateBg: 'rgba(255,255,255,0.08)',
    dateText: 'rgba(255,255,255,0.5)', starColor: '#f59e0b',
  },
  light: {
    id: 'light', name: 'Emerald Light', icon: '☀️',
    bg: '#f0f2f5', chatBg: '#e5ddd5',
    bgGrad: 'linear-gradient(160deg, #f0f2f5 0%, #e8eaf0 100%)',
    card: '#ffffff', cardBorder: 'rgba(0,0,0,0.08)',
    header: 'rgba(255,255,255,0.97)', footer: 'rgba(255,255,255,0.97)',
    text: '#111b21', textMuted: 'rgba(0,0,0,0.5)',
    accent: '#075e54', accentLight: '#128c7e',
    accentGrad: 'linear-gradient(135deg, #075e54, #128c7e)',
    bubbleMe: '#dcf8c6', bubbleMeText: '#111b21',
    bubbleThem: '#ffffff', bubbleThemBorder: 'rgba(0,0,0,0.08)',
    bubbleThemText: '#111b21',
    inputBg: 'rgba(0,0,0,0.04)', inputBorder: 'rgba(0,0,0,0.12)',
    inputText: '#111b21', placeholder: 'rgba(0,0,0,0.38)',
    iconMuted: 'rgba(0,0,0,0.45)',
    glass: 'rgba(0,0,0,0.04)', glassBorder: 'rgba(0,0,0,0.1)',
    divider: 'rgba(0,0,0,0.08)',
    glow: 'rgba(7,94,84,0.2)', dateBg: 'rgba(255,255,255,0.8)',
    dateText: 'rgba(0,0,0,0.55)', starColor: '#f59e0b',
  },
  ocean: {
    id: 'ocean', name: 'Deep Sea', icon: '🌊',
    bg: '#020b14', chatBg: '#020b14',
    bgGrad: 'linear-gradient(160deg, #020b14 0%, #041824 100%)',
    card: 'rgba(6,182,212,0.07)', cardBorder: 'rgba(6,182,212,0.22)',
    header: 'rgba(2,11,20,0.96)', footer: 'rgba(2,11,20,0.97)',
    text: '#cffafe', textMuted: 'rgba(207,250,254,0.42)',
    ...
    bubbleMeText: '#ffffff',
    bubbleThem: 'rgba(6,182,212,0.1)', bubbleThemBorder: 'rgba(6,182,212,0.22)',
    bubbleThemText: '#cffafe',
    inputBg: 'rgba(6,182,212,0.07)', inputBorder: 'rgba(6,182,212,0.22)',
    inputText: '#cffafe', placeholder: 'rgba(207,250,254,0.32)',
    iconMuted: 'rgba(207,250,254,0.45)',
    glass: 'rgba(6,182,212,0.09)', glassBorder: 'rgba(6,182,212,0.2)',
    divider: 'rgba(6,182,212,0.12)',
    glow: 'rgba(8,145,178,0.35)', dateBg: 'rgba(6,182,212,0.15)',
    dateText: 'rgba(207,250,254,0.6)', starColor: '#fbbf24',
  },
  forest: {
    id: 'forest', name: 'Deep Forest', icon: '🌿',
    bg: '#040f08', chatBg: '#040f08',
    bgGrad: 'linear-gradient(160deg, #040f08 0%, #071810 100%)',
    card: 'rgba(34,197,94,0.06)', cardBorder: 'rgba(34,197,94,0.2)',
    header: 'rgba(4,15,8,0.96)', footer: 'rgba(4,15,8,0.97)',
    text: '#dcfce7', textMuted: 'rgba(220,252,231,0.42)',
    ...
    bubbleMeText: '#ffffff',
    bubbleThem: 'rgba(34,197,94,0.09)', bubbleThemBorder: 'rgba(34,197,94,0.2)',
    bubbleThemText: '#dcfce7',
    inputBg: 'rgba(34,197,94,0.06)', inputBorder: 'rgba(34,197,94,0.2)',
    inputText: '#dcfce7', placeholder: 'rgba(220,252,231,0.32)',
    iconMuted: 'rgba(220,252,231,0.45)',
    glass: 'rgba(34,197,94,0.08)', glassBorder: 'rgba(34,197,94,0.18)',
    divider: 'rgba(34,197,94,0.12)',
    glow: 'rgba(22,163,74,0.35)', dateBg: 'rgba(34,197,94,0.15)',
    dateText: 'rgba(220,252,231,0.6)', starColor: '#fbbf24',
  },
};
...
const DoubleCheck = ({ reads, isLight }) => {
...
const Toast = ({ message, type = 'info', onClose }) => {
  ...
  return (
    <div style={{
      position: 'fixed', bottom: 80, left: '50%', transform: 'translateX(-50%)', zIndex: 500,
  ...
  <div onClick={e => e.stopPropagation()} style={{
    ...
    {EMOJIS.map((e, i) => (
      <button key={i} onClick={() => { onSelect(e); onClose(); }}
        title={e}
        style={{
          width: 36, height: 36, fontSize: 22, border: 'none', borderRadius: 8, cursor: 'pointer',
          background: 'transparent', display: 'flex', alignItems: 'center', justifyContext: 'center',
        ...
        onMouseEnter={ev => { ev.currentTarget.style.background = th.glass; ev.currentTarget.style.transform = 'scale(1.2)'; }}
...
const ThemePicker = ({ current, onChange, onClose, th }) => (
  <div style={{
    ...
    <p style={{ color: th.textMuted, fontSize: 10, fontWeight: 700, margin: '0 8px 6px', letterSpacing: 0.6 }}>THEME</p>
...
const ImageViewer = ({ src, onClose }) => (
  <div onClick={onClose} style={{
    position: 'fixed', inset: 0, background: 'rgba(0,0,0,.93)', zIndex: 600,
...
const CtxMenu = ({ x, y, items, onClose, th }) => {
  ...
  return (
    <div style={{
      position: 'fixed', top: my, left: mx, zIndex: 400, borderRadius: 14, overflow: 'hidden',
...
const DateSep = ({ label, th }) => (
  <div style={{ display: 'flex', justifyContent: 'center', margin: '14px 0' }}>
    <span style={{
      ...
      background: th.dateBg, color: th.dateText
    }}>{label}</span>
  </div>
);

/* ──────────── MESSAGE BUBBLE ──────────── */
const MsgBubble = React.memo(({ msg, isMe, username, isAdmin, onDelete, onSoftDelete, onReply, isNew, th, onStar }) => {
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, flexDirection: isMe ? 'row-reverse' : 'row', maxWidth: '88%' }}>
        ...
        <img src={msg.photoURL || 'https://api.dicebear.com/9.x/avataaars/svg?seed=user'} alt="av"
          style={{
            width: 28, height: 28, borderRadius: '50%', objectFit: 'cover', flexShrink: 0, marginBottom: 4,
        ...
        <div style={bubbleStyle}>
          ...
          {msg.replyTo && (
            <div style={{
              margin: isImg || isVid ? '8px 8px 4px' : '0 0 6px',
              ...
              <p style={{
                opacity: .7, margin: 0, color: textColor,
                overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical'
              }}>{msg.replyTo.text || '📷 Media'}</p>
            </div>
          )}
          ...
          {isImg && (
            <div style={{ position: 'relative', cursor: 'pointer', borderRadius: isMe ? '18px 18px 4px 18px' : '18px 18px 18px 4px', overflow: 'hidden' }} onClick={() => setImgView(true)}>
              ...
              <button onClick={e => { e.stopPropagation(); dlFile(msg.image, 'image.jpg'); }}
                style={{
                  position: 'absolute', top: 8, right: 8, padding: '5px 8px', borderRadius: 8,
          ...
          {!isImg && !isVid && (
            <div style={{
              ...
              {isMe && <DoubleCheck reads={reads} isLight={isLight} />}
            </div>
          )}
          ...
          {(isImg || isVid) && !msg.text && (
            <div style={{
              position: 'absolute', bottom: 10, right: 10, display: 'flex', alignItems: 'center', gap: 3,
              ...
              {isMe && <DoubleCheck reads={reads} isLight={false} />}
            </div>
          )}
        </div>
      </div>
...
export default function App() {
  ...
  /* ── TYPING HANDLER (Throttled to prevent Firestore limits) ── */
  ...
  const sendMessage = (e) => {
    ...
    // Removed !firebaseUser requirement to bypass anonymous auth failures/delays
    ...
    // Reset layout inputs instantly for smooth UX
    setNewMessage('');
  ...
  const inp = {
    background: th.inputBg, border: '1px solid ' + th.inputBorder, borderRadius: 12,
  ...
  const btn1 = {
    background: th.accentGrad, border: 'none', borderRadius: 12, color: '#fff',
  ...
  if (screen === 'login') return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: th.bgGrad, fontFamily: 'inherit', overflowY: 'auto' }}>
      ...
      <div style={{ maxWidth: 400, width: '100%', margin: '-28px auto 0', padding: '0 16px 32px', zIndex: 10, position: 'relative' }}>
        <div style={{
          background: th.id === 'light' ? '#fff' : th.card, backdropFilter: 'blur(30px)',
  ...
  /* ══ SCREEN: STUDY DASHBOARD (Rooms List) ══ */
  if (screen === 'rooms') {
    const studyRooms = [
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: th.bgGrad, color: th.text, fontFamily: 'inherit', overflowY: 'auto', boxSizing: 'border-box' }}>
        ...
        <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', background: th.header, backdropFilter: 'blur(20px)', borderBottom: `1px solid ${th.divider}`, zIndex: 50, flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <button onClick={handleLogout}
              style={{
                display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px', borderRadius: 10, border: `1px solid ${th.glassBorder}`,
                background: th.glass, color: th.text, fontSize: 12, fontWeight: 700, cursor: 'pointer', transition: 'all .15s'
              }}
        ...
        <main style={{ flex: 1, width: '100%', maxWidth: 1200, margin: '0 auto', padding: '24px 16px 40px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          <div style={{ background: th.id === 'light' ? '#fff' : th.card, border: `1px solid ${th.cardBorder}`, borderRadius: 18, padding: 20, backdropFilter: 'blur(20px)', boxShadow: '0 10px 30px rgba(0,0,0,.08)' }}>
            ...
            <form onSubmit={handleJoinRoom} style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
              ...
              <button type="submit" disabled={!roomInput.trim()}
                style={{
                  background: th.accentGrad, border: 'none', borderRadius: 12, color: '#fff', fontWeight: 700, padding: '12px 20px', cursor: 'pointer',
                  display: 'flex', alignItems: 'center', gap: 8, transition: 'opacity .2s', opacity: roomInput.trim() ? 1 : .45, boxShadow: `0 4px 15px ${th.glow}`
                }}>
                <span>Join Room</span>
                <ArrowRight size={16} />
              </button>
          ...
          {/* Grid Layout: Study Rooms Grid (Left) & Curated Materials (Right) */}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
                ...
                {studyRooms.map(rm => (
                  <div key={rm.code} onClick={() => { setRoomCode(rm.code); setScreen('chat'); }}
                    style={{
                      background: th.id === 'light' ? '#fff' : th.card, border: `1px solid ${th.cardBorder}`, borderRadius: 16, padding: 20,
                      cursor: 'pointer', transition: 'all .22s cubic-bezier(0.4, 0, 0.2, 1)', display: 'flex', flexDirection: 'column',
                      justifyContent: 'space-between', gap: 12, position: 'relative', overflow: 'hidden'
                    }}
                ...
                <div onClick={joinPublicRoom}
                  style={{
                    background: 'rgba(59,130,246,.08)', border: '1px solid rgba(59,130,246,.25)', borderRadius: 16, padding: 20,
                    cursor: 'pointer', transition: 'all .22s', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 12
                  }}
                ...
                {studyMaterials.map((mat, idx) => (
                  ...
                  >
                    ...
                    <button onClick={() => handleDownloadMaterial(mat)}
                      style={{
                        width: 32, height: 32, borderRadius: 8, background: th.glass, border: `1px solid ${th.glassBorder}`, cursor: 'pointer',
                        display: 'flex', alignItems: 'center', justifyContent: 'center', color: th.text, transition: 'all .15s'
                      }}
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: th.chatBg, position: 'relative', overflow: 'hidden' }}
      ...
      {/* Header Panel */}
      <header style={{
        background: th.header, backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)',
        ...
        <div style={{ display: 'flex', gap: 7, alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {showMoreMenu && (
              <div onClick={e => e.stopPropagation()} style={{
                position: 'absolute', top: 'calc(100% + 6px)', right: 0, background: th.id === 'light' ? '#fff' : 'rgba(22,22,35,.98)',
                backdropFilter: 'blur(20px)', border: '1px solid ' + th.cardBorder, borderRadius: 12, overflow: 'hidden', zIndex: 200,
                minWidth: 160, boxShadow: '0 12px 40px rgba(0,0,0,.4)', animation: 'waFadeUp .15s ease'
              }}>
                {[
                  ...
                  <button key={i} onClick={() => { item.action(); setShowMoreMenu(false); }}
                    style={{
                      display: 'flex', alignItems: 'center', gap: 9, width: '100%', padding: '11px 14px', border: 'none', cursor: 'pointer',
                      fontSize: 13, fontWeight: 500, background: 'transparent', color: item.danger ? '#f87171' : th.text, fontFamily: 'inherit', transition: 'background .12s'
                    }}
                    onMouseEnter={ev => ev.currentTarget.style.background = th.glass}
                    onMouseLeave={ev => ev.currentTarget.style.background = 'transparent'}
        ...
        {typingUsers.length > 0 && (
          <div style={{ display: 'flex', padding: '2px 12px', animation: 'waFadeUp .3s ease' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6 }}>
              ...
              <div style={{
                display: 'flex', alignItems: 'center', gap: 5, padding: '9px 14px', borderRadius: '18px 18px 18px 4px',
                background: th.id === 'light' ? '#fff' : th.bubbleThem, border: '1px solid ' + th.bubbleThemBorder
              }}>
      ...
      <div style={{ background: th.footer, backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderTop: '1px solid ' + th.divider, position: 'relative', zIndex: 20, flexShrink: 0 }}>
        {/* Media Preview Attachment Panel */}
        {hasMedia && (
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 7, maxWidth: 960, margin: '0 auto' }}>
            ...
            <div style={{ flex: 1, position: 'relative' }}>
              <textarea ref={inputRef} value={newMessage} onChange={handleTyping}
                ...
                rows={1}
                style={{
                  width: '100%', background: th.inputBg, border: '1px solid ' + th.inputBorder, borderRadius: 24, padding: '10px 16px',
                  color: th.inputText, fontSize: 14, fontFamily: 'inherit', resize: 'none', outline: 'none',
                  transition: 'border-color .2s, box-shadow .2s', lineHeight: 1.5, maxHeight: 110, overflowY: 'auto', boxSizing: 'border-box', display: 'block'
                }}
                onFocus={focusIn} onBlur={focusOut}
            ...
            <button type="button" onClick={sendMessage} disabled={!canSend}
              style={{
                ...
                border: 'none', transition: 'all .2s', cursor: canSend ? 'pointer' : 'default',
